...
var app = angular.module('Paper', ['ngMaterial', 'ui.router']);
...
app.config(function($mdThemingProvider) {
  var primaryMap = $mdThemingProvider.extendPalette('deep-purple', {
    '50': '#ffffff',
    'contrastDefaultColor': 'light'
  });
  $mdThemingProvider.definePalette('customPrimary', primaryMap);
